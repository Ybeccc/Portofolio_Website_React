...
const Header = () => {
    ...
    window.addEventListener("scroll", function () {
        ...
        // when the scroll is higher than 200 viewport height, add the scroll-header class to a tag with the sheader tag
    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Ribka</a>
