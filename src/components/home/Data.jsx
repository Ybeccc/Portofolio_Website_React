...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Ribka Suwardy
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> A well-rounded person who has an interest to be a frontend developer and always willing to learn new skills.</p>
